...
export default function PreviewCV() {
  ...
  return <div className="lg:w-full -mt-56 -mb-58 lg:mt-0 lg:bg-slate-100 px-6 py-3 flex items-center flex-col scale-60 transform-gpu lg:scale-none lg:transform-none relative">
